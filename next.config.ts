...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/home/contact', destination: '/contact', permanent: true },
      { source: '/Home/About', destination: '/#facility', permanent: true },
      { source: '/home/about', destination: '/#facility', permanent: true },
      ...
      { source: '/Instructors', destination: '/team', permanent: true },
      { source: '/Instructors/:path*', destination: '/team', permanent: true },
      ...
      { source: '/about', destination: '/#facility', permanent: true },
      { source: '/about-us', destination: '/#facility', permanent: true },
      ...
      { source: '/Service/:path*', destination: '/programs', permanent: true },
      { source: '/Trainers', destination: '/team', permanent: true },
      { source: '/trainers', destination: '/team', permanent: true },
      { source: '/Trainers/:path*', destination: '/team', permanent: true },
      { source: '/trainers/:path*', destination: '/team', permanent: true },
